...
API_ID = int(environ.get('API_ID', '16373673'))
API_HASH = environ.get('API_HASH', '0aab381b277aeef3bb609bfa954194ec')
BOT_TOKEN = environ.get('BOT_TOKEN', "5849256689:AAHammeh2670CJa7nny3o_yJ7527Aji6NZA")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1475708538').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '0').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '1475708538').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
auth_channel = environ.get('AUTH_CHANNEL', '-1001883430960')
...
DOWNLOAD_TEXT_URL = "https://t.me/How_to_Download_From_Search_Bot"
